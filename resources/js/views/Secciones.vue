<template>
    <div>
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Crear Seccion</li>
        </ol>
        <div id="panel-1" class="panel">
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="row">
                        <div class="col">
                            <button v-if="bolean_index" @click="Bolean_insertar()" class="btn btn-primary waves-effect waves-themed">Crear Seccion</button>
        ...
        <div v-if="bolean_index" id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <span class="fw-300"><i>Seccion</i></span>
                </h2>
            </div>
            <div class="panel-container show">
                <div class="panel-content">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-15">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class=" form-control" value="" v-model="Seccion_model.code" placeholder="Codigo" required>
                                        ...
                                        <div class="col-12 mb-15">
                                            <div class="form-group">
                                                ...
                                                <input name="name" type="text" class=" form-control" value="" v-model="Seccion_model.description" placeholder="Descripcion" required>
                                                <div class="invalid-feedback">Este campo es obligatorio</div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div v-if="bolean_edit" id="panel-1" class="panel col-md-6">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="row">
                        <form @submit.prevent="BUpdate(Seccion_model)" style="width:100%">
                            <div class="row">
                                <div class="col-md-12 mb-15" id="app_ticket">
                                    <div class="row">
                                        <div class="col-sm-12 mb-15">
                                            <div class="form-group">
                                                <label class="form-label" for="name">Codigo</label>
                                                <input name="descripcion" type="text" class=" form-control" value="" v-model="Seccion_model.code" placeholder="Codigo" required>
                                                <div class="invalid-feedback">Este campo es obligatorio</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 mb-15">
                                            <div class="form-group">
                                                <label class="form-label" for="name">Descripcion</label>
                                                <input name="descripcion" type="text" class=" form-control" value="" v-model="Seccion_model.description" placeholder="Descripcion" required>
                                                <div class="invalid-feedback">Este campo es obligatorio</div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    export default {
        data() {
            return{
                Options: [],
                Seccion_model: {id:'',code:'',description:'',legend:''},
                bolean_index: true,
        ...
        created() {
            axios.get("/Consultas").then(res => {
                ...
                this.Options = consultasCriterias['Seccions']
                this.Tabla()
            });
        },
        methods: {
            ...
            Editar(item){
                $('#dt-basic-example').dataTable().fnDestroy();
                this.Seccion_model = {id:'',code:'',description:'',legend:''}
                this.bolean_index = false
                this.bolean_crear = false
                this.bolean_edit = true
                this.Seccion_model = {id:item.id,code:item.code,description:item.description,legend:item.legend}
            },
            Bstore(){
                $('#dt-basic-example').dataTable()
                let formData = new FormData()
                formData.append('code',this.Seccion_model.code)
                formData.append('description',this.Seccion_model.description)
                formData.append('legend',this.Seccion_model.legend)
            ...
            BUpdate(Seccion_model){
                let formData = new FormData()
                formData.append("_method", "put")
                formData.append('code',this.Seccion_model.code)
                formData.append('description',this.Seccion_model.description)
                formData.append('legend',this.Seccion_model.legend)
                axios.post(`/Optioncriterias/${Seccion_model.id}`, formData)
                    .then((res) =>{
                        this.Atras()
                        const index = this.Options.findIndex(item => item.id === Seccion_model.id);
